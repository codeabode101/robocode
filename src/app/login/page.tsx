    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
      <div className="w-full max-w-md p-8 space-y-6 bg-slate-900/90 border border-slate-700/50 rounded-2xl shadow-2xl">
        <div className="text-center">
          ...
          <p className="mt-2 text-slate-400">Learn Java. Battle friends. Build a world.</p>
        </div>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" className="w-full bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 py-2.5 rounded-lg font-bold text-lg text-slate-900 shadow-lg shadow-amber-500/20 transition-all">
            Sign In
          </button>
        </form>
        ...
        <p className="text-center text-sm text-slate-400">
          Don't have an account?{' '}
           <a href="/signup" className="text-amber-400 hover:text-amber-300 font-semibold transition-colors">Sign Up</a>
        </p>
      </div>
    </div>
  );
