...
export function buildObstacles(params: ObstacleParams): Hitbox[] {
  ...
  return [
    ...
    { shape: 'box', center: { x: -7, y: 4 }, halfWidth: 1.75, halfHeight: 1.25 },
    { shape: 'box', center: { x: -4, y: 3.5 }, halfWidth: 1.25, halfHeight: 1.0 },
    { shape: 'box', center: { x: -3.5, y: 5.5 }, halfWidth: 1.0, halfHeight: 0.75 },
    // Top-center block
    { shape: 'box', center: { x: 4.5, y: 4 }, halfWidth: 1.5, halfHeight: 1.25 },
    { shape: 'box', center: { x: 8.5, y: 4.5 }, halfWidth: 1.25, halfHeight: 1.0 },
    { shape: 'box', center: { x: 3.5, y: 2.5 }, halfWidth: 1.0, halfHeight: 0.75 },
    // Top-right block
    { shape: 'box', center: { x: 16.5, y: 4 }, halfWidth: 1.75, halfHeight: 1.25 },
    { shape: 'box', center: { x: 19.5, y: 3.5 }, halfWidth: 1.5, halfHeight: 1.0 },
    { shape: 'box', center: { x: 22, y: 5 }, halfWidth: 1.25, halfHeight: 1.0 },
    // Mid-right block
    { shape: 'box', center: { x: 16.5, y: -4 }, halfWidth: 1.75, halfHeight: 1.25 },
    { shape: 'box', center: { x: 20, y: -3 }, halfWidth: 1.5, halfHeight: 1.0 },
    { shape: 'box', center: { x: 22, y: -5 }, halfWidth: 1.25, halfHeight: 0.75 },
  ];
}
